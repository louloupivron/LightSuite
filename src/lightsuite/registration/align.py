...
from lightsuite.registration.warp import (
    ...
    matlab_voxel_affine_from_zero_based,
)
...
def _estimate_similarity_bcpd(
    ...
    transform_icp = atlas_to_sample_affinetform(atlas_to_sample)
    matlab_transform = matlab_voxel_affine_from_zero_based(transform_icp)
